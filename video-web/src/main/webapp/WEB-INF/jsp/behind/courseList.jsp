    ...
    <table class="table table-bordered table-hover"
        ...
        <c:forEach items="${page.rows}" var="course" varStatus="status">
            <tr>
                ...
                <td style="overflow:hidden;white-space:nowrap;text-overflow:ellipsis;">${course.course_desc}</td>
                ...
                <td><a href="#" onclick="return delSpeakerById(this,'${course.id}','${course.course_title}')"><span
...
<div class="container">
    <div class="navbar-right" style="padding-right: 17px">
        <p:page url="${pageContext.request.contextPath}/course/showCourseList"></p:page>
    </div>
</div>
</body>
