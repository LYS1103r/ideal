...
<div class="container" style="margin-top: 20px;">
    ...
    <form class="form-horizontal" action="${pageContext.request.contextPath}/speaker/saveOrUpdate" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="speaker_name" value="${speaker.speaker_name}" placeholder="主讲人名称">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="speaker_job" class="form-control" value="${speaker.speaker_job}" placeholder="主讲人职位">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" name="speaker_desc" rows="3">${speaker.speaker_desc}</textarea>
            </div>
        </div>

        <div class="form-group">
            <label class="col-sm-2 control-label">头像图片地址</label>
            <div class="col-sm-10">
                <input type="url" name="head_img_url" class="form-control" value="${speaker.head_img_url}" placeholder="具体的url">
            </div>
        </div>
