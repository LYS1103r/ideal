...
<nav class="w100">
    <div class="container">
        <img src="${pageContext.request.contextPath}/img/logoT.png" alt="Y先生教育的logo" onclick="location.href='${pageContext.request.contextPath}/index/choose'"
             draggable="false">
        <ul class="text_13 f_right">
            <li>
                <a href="${pageContext.request.contextPath}/index/login">首页</a>
            </li>
            <li class="nav_down">
...
<div id="app">
    ...
    <!--面包屑导航-->
    <div class="container mian-nav">Web课 / ${subject.subject_name}</div>
        ...
        <div class="container">
            ...
            <c:forEach items="${subject.courseList}" var="course">
                <div class="section">
                    ...
                    <div class="kcIntro">
                        <p class="int"><span>课程介绍：</span>${course.course_desc}
                        </p>
                    </div>
                    <ul>
                        <!--节-->
                        <c:forEach items="${course.videoList}" var="video" varStatus="i">
                            <li class="section-main" onclick="getVideo(${video.id})">
                                <div class="thum" style="background-image: url('${video.image_url}')">
...
<script type="text/javascript">
    ...
    function getVideo(videoId) {
        ...
        if ((null != "${sessionScope.userAccount}" && "${sessionScope.userAccount}" != "") || ($("#isLogin").val() == 1)) {
            //如果登录
            location.href = "${pageContext.request.contextPath}/video/showVideo?videoId=" + videoId + "&subjectName=" + '${subject.subject_name}';
        } else {
            //如果不登录，弹登录框
