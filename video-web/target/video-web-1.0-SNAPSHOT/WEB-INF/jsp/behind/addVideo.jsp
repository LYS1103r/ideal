...
<head>
    ...
    <script type="text/javascript">
        ...
        //页面加载完毕之后就执行以下代码片段
        $(function () {
            var speakerId = '${video.spearker_id}';
...
<div class="container" style="margin-top: 20px;">
    ...
    <form class="form-horizontal" action="${pageContext.request.contextPath}/video/saveOrUpdate" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <div class="input-group">
                        ...
                        <ul id="selectSpeaker" class="dropdown-menu">
                            <c:forEach items="${speakerList}" var="speaker">
                                <li value='${speaker.id}'><a href="#"
                                                             onclick="showName(this,'${speaker.id}',1)">${speaker.speaker_name}</a>
                                </li>
                            </c:forEach>
                    ...
                    <c:if test="${empty video.spearker_id}">
                        <input type="hidden" class="form-control" id="speakerId" name="spearker_id" value="0">
                    </c:if>
                    <c:if test="${not empty video.spearker_id}">
                        <input type="hidden" class="form-control" id="speakerId" name="spearker_id"
                               value="${video.spearker_id}">
                    </c:if>
            ...
            <div class="col-sm-10">
                <div class="input-group">
                        ...
                        <ul id="selectCourse" class="dropdown-menu">
                            <c:forEach items="${courseList}" var="course">
                                <li value="${course.id}"><a href="#"
                                                            onclick="showName(this,${course.id},2)">${course.course_title}</a>
                                </li>
                            </c:forEach>
                    ...
                    <c:if test="${empty video.course_id}">
                        <input type="hidden" class="form-control" id="courseId" name="course_id" value="0">
                    </c:if>
                    <c:if test="${not empty video.course_id}">
                        <input type="hidden" class="form-control" id="courseId" name="course_id" value="${video.course_id}">
                    </c:if>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="url" name="image_url" class="form-control" value="${video.image_url}" placeholder="具体的url">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="url" name="video_url" class="form-control" value="${video.video_url}" placeholder="具体的url">
            </div>
        </div>
