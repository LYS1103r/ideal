...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var courseId = '${course.subject_id}';
...
<div class="container" style="margin-top: 20px;">
    ...
    <form class="form-horizontal" action="${pageContext.request.contextPath}/course/saveOrUpdate" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="course_title" value="${course.course_title}" placeholder="课程名称">
            </div>
        </div>
<%--
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" name="course_desc" rows="3">${course.course_desc}</textarea>
            </div>
        </div>
            ...
            <div class="col-sm-10">
                <div class="input-group">
                        ...
                        <ul id="selectCourse" class="dropdown-menu">
                            <c:forEach items="${subjectList}" var="subject">
                                <li value="${subject.id}"><a href="#"
                                                            onclick="showName(this,${subject.id},2)">${subject.subject_name}</a>
                                </li>
                            </c:forEach>
                    ...
                    <c:if test="${empty course.subject_id}">
                        <input type="hidden" class="form-control" id="courseId" name="subject_id" value="0">
                    </c:if>
                    <c:if test="${not empty course.subject_id}">
                        <input type="hidden" class="form-control" id="courseId" name="subject_id" value="${course.subject_id}">
                    </c:if>
